        ...
        <div className="navbar navbar-expand border p-0">
            <div className="container" style={{height: '100%'}}>
                ...
                <ul className="navbar-nav gap-4 align-items-center">
                    <li className="nav-link-container"><span className='nav-link'><Link className='nav-link' to='/'>Products</Link></span></li>
                    <li className="nav-link-container"><span className='nav-link'><Link className='nav-link' to='/Categories'>Categories</Link></span></li>
                    <li className="nav-link-container"><span className='nav-link'><Link className='nav-link' to='/AboutUs'>About us</Link></span></li>
                </ul>
